...
while True:
    ...
    if posListX:
        ...
        if prediction:
            cvzone.putTextRect(imgContours, "Basket", (150, 150),
                               scale=5, thickness=5, colorR=(100, 100, 0), offset=20)
        else:
            cvzone.putTextRect(imgContours, "No Basket", (150, 150),
                               scale=5, thickness=5, colorR=(100, 100, 200), offset=20)
